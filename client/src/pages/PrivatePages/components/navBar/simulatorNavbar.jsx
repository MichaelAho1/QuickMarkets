...
import { IoIosArrowDown } from "react-icons/io"; // Caret icon
...
const Navbar = () => {
    ...
    // Simulated stock data with day changes (as of Saturday, May 3, 2025)
    const stocks = [
    ...
    return (
        <nav className={styles.navBar}>
            <div className={styles.navbarHeader}>
                <img src={logo} alt="QuickMarkets Logo"></img>
